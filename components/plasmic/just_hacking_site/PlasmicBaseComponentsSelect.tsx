...
import BaseComponentsLabel from "../../BaseComponentsLabel"; // plasmic-import: RPiuKtGOqoBK/component
...
import BaseComponentsUnusedMenuPopover from "../../BaseComponentsUnusedMenuPopover"; // plasmic-import: 9qae9ODPa9_W/component
...
import sty from "./PlasmicBaseComponentsSelect.module.css"; // plasmic-import: oTAIGDwrFYsE/css
...
export type PlasmicBaseComponentsSelect__OverridesType = {
  ...
  freeBox?: Flex__<"div">;
  svg?: Flex__<"svg">;
  baseComponentsUnusedMenuPopover?: Flex__<
    typeof BaseComponentsUnusedMenuPopover
  >;
};
...
function PlasmicBaseComponentsSelect__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <BaseComponentsUnusedMenuPopover
        data-plasmic-name={"baseComponentsUnusedMenuPopover"}
        data-plasmic-override={overrides.baseComponentsUnusedMenuPopover}
        className={classNames(
          "__wab_instance",
          sty.baseComponentsUnusedMenuPopover,
          {
            [sty.baseComponentsUnusedMenuPopovertype_plain]: hasVariant(
              $state,
              "type",
              "plain"
            )
          ...
          defaultContents: (
            <React.Fragment>
              <BaseComponentsMenuItem
                className={classNames(
                  "__wab_instance",
                  sty.baseComponentsMenuItem__nfgwo
                )}
                value={"item1"}
              />
              ...
              <BaseComponentsMenuItem
                className={classNames(
                  "__wab_instance",
                  sty.baseComponentsMenuItem__eGrlR
                )}
                label={"Item 2"}
                value={"item2"}
              />
              ...
              <BaseComponentsMenuItem
                className={classNames(
                  "__wab_instance",
                  sty.baseComponentsMenuItem__xoLRr
                )}
                label={"Item 3"}
                value={"item3"}
              />
              ...
              <BaseComponentsUnusedMenuSection
                className={classNames(
                  "__wab_instance",
                  sty.baseComponentsUnusedMenuSection__tqKRx
                )}
                items={
                  <React.Fragment>
                    <BaseComponentsMenuItem
                      className={classNames(
                        "__wab_instance",
                        sty.baseComponentsMenuItem__gtd7
                      )}
...
const PlasmicDescendants = {
  ...
  freeBox: ["freeBox"],
  svg: ["svg"],
  baseComponentsUnusedMenuPopover: ["baseComponentsUnusedMenuPopover"]
} as const;
...
type NodeDefaultElementType = {
  ...
  freeBox: "div";
  svg: "svg";
  baseComponentsUnusedMenuPopover: typeof BaseComponentsUnusedMenuPopover;
};
...
export const PlasmicBaseComponentsSelect = Object.assign(
  ...
  makeNodeComponent("ariaSelect"),
  {
    ...
    baseComponentsUnusedMenuPopover: makeNodeComponent(
      "baseComponentsUnusedMenuPopover"
    ),
