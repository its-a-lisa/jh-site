...
import sty from "./PlasmicBaseComponentsTextInput.module.css"; // plasmic-import: y55jmOJB_ZER/css

createPlasmicElementProxy;

export type PlasmicBaseComponentsTextInput__VariantMembers = {
  type: "soft" | "plain";
  flat: "top" | "right" | "bottom" | "left";
  padded: "left" | "right";
};
export type PlasmicBaseComponentsTextInput__VariantsArgs = {
  type?: SingleChoiceArg<"soft" | "plain">;
  flat?: MultiChoiceArg<"top" | "right" | "bottom" | "left">;
  padded?: MultiChoiceArg<"left" | "right">;
};
type VariantPropType = keyof PlasmicBaseComponentsTextInput__VariantsArgs;
export const PlasmicBaseComponentsTextInput__VariantProps =
  new Array<VariantPropType>("type", "flat", "padded");

export type PlasmicBaseComponentsTextInput__ArgsType = {
  placeholder?: string;
  defaultValue?: string;
  disabled?: boolean;
  readOnly?: boolean;
...
type ArgPropType = keyof PlasmicBaseComponentsTextInput__ArgsType;
export const PlasmicBaseComponentsTextInput__ArgProps = new Array<ArgPropType>(
  "placeholder",
  "defaultValue",
  "disabled",
  "readOnly",
...
export type PlasmicBaseComponentsTextInput__OverridesType = {
  ariaInput?: Flex__<typeof BaseInput>;
};

export interface DefaultBaseComponentsTextInputProps {
  placeholder?: string;
  defaultValue?: string;
  disabled?: boolean;
  readOnly?: boolean;
...
function PlasmicBaseComponentsTextInput__RenderFunc(props: {
  variants: PlasmicBaseComponentsTextInput__VariantsArgs;
  args: PlasmicBaseComponentsTextInput__ArgsType;
  overrides: PlasmicBaseComponentsTextInput__OverridesType;
  forNode?: string;
}) {
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicBaseComponentsTextInput__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicBaseComponentsTextInput__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    /* Specify args directly as props*/ Omit<
      PlasmicBaseComponentsTextInput__ArgsType,
      ReservedPropsType
    > &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicBaseComponentsTextInput__ArgProps,
          internalVariantPropNames: PlasmicBaseComponentsTextInput__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicBaseComponentsTextInput__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "ariaInput") {
    func.displayName = "PlasmicBaseComponentsTextInput";
  } else {
    func.displayName = `PlasmicBaseComponentsTextInput.${nodeName}`;
  }
  return func;
}

export const PlasmicBaseComponentsTextInput = Object.assign(
  // Top-level PlasmicBaseComponentsTextInput renders the root element
  makeNodeComponent("ariaInput"),
  {
    // Helper components rendering sub-elements

    // Metadata about props expected for PlasmicBaseComponentsTextInput
    internalVariantProps: PlasmicBaseComponentsTextInput__VariantProps,
    internalArgProps: PlasmicBaseComponentsTextInput__ArgProps
  }
);

export default PlasmicBaseComponentsTextInput;
/* prettier-ignore-end */
