...
export function Icon8Icon(props: Icon8IconProps) {
  ...
  return (
    ...
    >
      ...
      <path fill={"var(--token-ilO0Nn-AQ6vr)"} d={"M0 0h3000v2000H0z"}></path>

      <defs>
        <g id={"H9shzjc0lgOXa"} fill={"var(--token-xvmS7UfqD42l)"}>
          <circle r={".5"}></circle>
        ...
        <g id={"H9shzjc0lgOXb"}>
          <use x={"40"} href={"#H9shzjc0lgOXa"}></use>

          <use x={"30"} y={"20"} href={"#H9shzjc0lgOXa"}></use>

          <use x={"20"} y={"40"} href={"#H9shzjc0lgOXa"}></use>

          <use x={"10"} y={"60"} href={"#H9shzjc0lgOXa"}></use>

          <use y={"80"} href={"#H9shzjc0lgOXa"}></use>
        </g>

        <g id={"H9shzjc0lgOXc"}>
          <use x={"250"} href={"#H9shzjc0lgOXb"}></use>

          <use x={"200"} y={"100"} href={"#H9shzjc0lgOXb"}></use>

          <use x={"150"} y={"200"} href={"#H9shzjc0lgOXb"}></use>

          <use x={"100"} y={"300"} href={"#H9shzjc0lgOXb"}></use>

          <use x={"50"} y={"400"} href={"#H9shzjc0lgOXb"}></use>

          <use y={"500"} href={"#H9shzjc0lgOXb"}></use>
        </g>
      </defs>

      <g transform={"rotate(-104.4 568.92 -40.88)"}>
        <use transform={"translate(-900 600)"} href={"#H9shzjc0lgOXc"}></use>

        <use transform={"translate(-600)"} href={"#H9shzjc0lgOXc"}></use>

        <use transform={"translate(-300 -600)"} href={"#H9shzjc0lgOXc"}></use>

        <use transform={"translate(0 -1200)"} href={"#H9shzjc0lgOXc"}></use>
      </g>
    </svg>
  );
}
