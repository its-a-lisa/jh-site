...
export function Icon11Icon(props: Icon11IconProps) {
  ...
  return (
    ...
    >
      ...
      <defs>
        <g id={"8Wki80LGkeIRa"} fill={"var(--token-xvmS7UfqD42l)"}>
          <circle r={".5"}></circle>
        ...
        <g id={"8Wki80LGkeIRb"}>
          <use x={"40"} href={"#8Wki80LGkeIRa"}></use>

          <use x={"30"} y={"20"} href={"#8Wki80LGkeIRa"}></use>

          <use x={"20"} y={"40"} href={"#8Wki80LGkeIRa"}></use>

          <use x={"10"} y={"60"} href={"#8Wki80LGkeIRa"}></use>

          <use y={"80"} href={"#8Wki80LGkeIRa"}></use>
        </g>

        <g id={"8Wki80LGkeIRc"}>
          <use x={"250"} href={"#8Wki80LGkeIRb"}></use>

          <use x={"200"} y={"100"} href={"#8Wki80LGkeIRb"}></use>

          <use x={"150"} y={"200"} href={"#8Wki80LGkeIRb"}></use>

          <use x={"100"} y={"300"} href={"#8Wki80LGkeIRb"}></use>

          <use x={"50"} y={"400"} href={"#8Wki80LGkeIRb"}></use>

          <use y={"500"} href={"#8Wki80LGkeIRb"}></use>
        </g>
      </defs>

      <g transform={"rotate(-104.4 568.92 -40.88)"}>
        <use transform={"translate(-900 600)"} href={"#8Wki80LGkeIRc"}></use>

        <use transform={"translate(-600)"} href={"#8Wki80LGkeIRc"}></use>

        <use transform={"translate(-300 -600)"} href={"#8Wki80LGkeIRc"}></use>

        <use transform={"translate(0 -1200)"} href={"#8Wki80LGkeIRc"}></use>
      </g>
    </svg>
  );
}
