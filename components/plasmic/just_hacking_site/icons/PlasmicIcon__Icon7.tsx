...
export function Icon7Icon(props: Icon7IconProps) {
  ...
  return (
    ...
    >
      ...
      <path fill={"var(--token-ilO0Nn-AQ6vr)"} d={"M0 0h3000v1000H0z"}></path>

      <defs>
        <g id={"1Rmc7_uCeTOya"} fill={"var(--token-xvmS7UfqD42l)"}>
          <circle r={".5"}></circle>
        ...
        <g id={"1Rmc7_uCeTOyb"}>
          <use x={"40"} href={"#1Rmc7_uCeTOya"}></use>

          <use x={"30"} y={"20"} href={"#1Rmc7_uCeTOya"}></use>

          <use x={"20"} y={"40"} href={"#1Rmc7_uCeTOya"}></use>

          <use x={"10"} y={"60"} href={"#1Rmc7_uCeTOya"}></use>

          <use y={"80"} href={"#1Rmc7_uCeTOya"}></use>
        </g>

        <g id={"1Rmc7_uCeTOyc"}>
          <use x={"250"} href={"#1Rmc7_uCeTOyb"}></use>

          <use x={"200"} y={"100"} href={"#1Rmc7_uCeTOyb"}></use>

          <use x={"150"} y={"200"} href={"#1Rmc7_uCeTOyb"}></use>

          <use x={"100"} y={"300"} href={"#1Rmc7_uCeTOyb"}></use>

          <use x={"50"} y={"400"} href={"#1Rmc7_uCeTOyb"}></use>

          <use y={"500"} href={"#1Rmc7_uCeTOyb"}></use>
        </g>
      </defs>

      <g transform={"rotate(-104.4 568.92 -40.88)"}>
        <use transform={"translate(-900 600)"} href={"#1Rmc7_uCeTOyc"}></use>

        <use transform={"translate(-600)"} href={"#1Rmc7_uCeTOyc"}></use>

        <use transform={"translate(-300 -600)"} href={"#1Rmc7_uCeTOyc"}></use>

        <use transform={"translate(0 -1200)"} href={"#1Rmc7_uCeTOyc"}></use>
      </g>
    </svg>
  );
}
