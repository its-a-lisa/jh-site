...
export function Icon13Icon(props: Icon13IconProps) {
  ...
  return (
    ...
    >
      ...
      <defs>
        <g id={"mKKQik9rIMXTa"} fill={"var(--token-xvmS7UfqD42l)"}>
          <circle r={".5"}></circle>
        ...
        <g id={"mKKQik9rIMXTb"}>
          <use x={"40"} href={"#mKKQik9rIMXTa"}></use>

          <use x={"30"} y={"20"} href={"#mKKQik9rIMXTa"}></use>

          <use x={"20"} y={"40"} href={"#mKKQik9rIMXTa"}></use>

          <use x={"10"} y={"60"} href={"#mKKQik9rIMXTa"}></use>

          <use y={"80"} href={"#mKKQik9rIMXTa"}></use>
        </g>

        <g id={"mKKQik9rIMXTc"}>
          <use x={"250"} href={"#mKKQik9rIMXTb"}></use>

          <use x={"200"} y={"100"} href={"#mKKQik9rIMXTb"}></use>

          <use x={"150"} y={"200"} href={"#mKKQik9rIMXTb"}></use>

          <use x={"100"} y={"300"} href={"#mKKQik9rIMXTb"}></use>

          <use x={"50"} y={"400"} href={"#mKKQik9rIMXTb"}></use>

          <use y={"500"} href={"#mKKQik9rIMXTb"}></use>
        </g>
      </defs>

      <g transform={"rotate(-104.4 568.92 -40.88)"}>
        <use transform={"translate(-900 600)"} href={"#mKKQik9rIMXTc"}></use>

        <use transform={"translate(-600)"} href={"#mKKQik9rIMXTc"}></use>

        <use transform={"translate(-300 -600)"} href={"#mKKQik9rIMXTc"}></use>

        <use transform={"translate(0 -1200)"} href={"#mKKQik9rIMXTc"}></use>
      </g>
    </svg>
  );
}
