...
export function Icon10Icon(props: Icon10IconProps) {
  ...
  return (
    ...
    >
      ...
      <defs>
        <g id={"E4TASzprmQLla"} fill={"var(--token-xvmS7UfqD42l)"}>
          <circle r={".5"}></circle>
        ...
        <g id={"E4TASzprmQLlb"}>
          <use x={"40"} href={"#E4TASzprmQLla"}></use>

          <use x={"30"} y={"20"} href={"#E4TASzprmQLla"}></use>

          <use x={"20"} y={"40"} href={"#E4TASzprmQLla"}></use>

          <use x={"10"} y={"60"} href={"#E4TASzprmQLla"}></use>

          <use y={"80"} href={"#E4TASzprmQLla"}></use>
        </g>

        <g id={"E4TASzprmQLlc"}>
          <use x={"250"} href={"#E4TASzprmQLlb"}></use>

          <use x={"200"} y={"100"} href={"#E4TASzprmQLlb"}></use>

          <use x={"150"} y={"200"} href={"#E4TASzprmQLlb"}></use>

          <use x={"100"} y={"300"} href={"#E4TASzprmQLlb"}></use>

          <use x={"50"} y={"400"} href={"#E4TASzprmQLlb"}></use>

          <use y={"500"} href={"#E4TASzprmQLlb"}></use>
        </g>
      </defs>

      <g transform={"rotate(-104.4 568.92 -40.88)"}>
        <use transform={"translate(-900 600)"} href={"#E4TASzprmQLlc"}></use>

        <use transform={"translate(-600)"} href={"#E4TASzprmQLlc"}></use>

        <use transform={"translate(-300 -600)"} href={"#E4TASzprmQLlc"}></use>

        <use transform={"translate(0 -1200)"} href={"#E4TASzprmQLlc"}></use>
      </g>
    </svg>
  );
}
