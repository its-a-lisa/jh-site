...
export function Icon12Icon(props: Icon12IconProps) {
  ...
  return (
    ...
    >
      ...
      <path fill={"var(--token-ilO0Nn-AQ6vr)"} d={"M0 0h600v1500H0z"}></path>

      <defs>
        <g id={"3SRKbtyo_wZEa"} fill={"var(--token-xvmS7UfqD42l)"}>
          <circle r={".5"}></circle>
        ...
        <g id={"3SRKbtyo_wZEb"}>
          <use x={"40"} href={"#3SRKbtyo_wZEa"}></use>

          <use x={"30"} y={"20"} href={"#3SRKbtyo_wZEa"}></use>

          <use x={"20"} y={"40"} href={"#3SRKbtyo_wZEa"}></use>

          <use x={"10"} y={"60"} href={"#3SRKbtyo_wZEa"}></use>

          <use y={"80"} href={"#3SRKbtyo_wZEa"}></use>
        </g>

        <g id={"3SRKbtyo_wZEc"}>
          <use x={"250"} href={"#3SRKbtyo_wZEb"}></use>

          <use x={"200"} y={"100"} href={"#3SRKbtyo_wZEb"}></use>

          <use x={"150"} y={"200"} href={"#3SRKbtyo_wZEb"}></use>

          <use x={"100"} y={"300"} href={"#3SRKbtyo_wZEb"}></use>

          <use x={"50"} y={"400"} href={"#3SRKbtyo_wZEb"}></use>

          <use y={"500"} href={"#3SRKbtyo_wZEb"}></use>
        </g>
      </defs>

      <g transform={"rotate(-104.4 568.92 -40.88)"}>
        <use transform={"translate(-900 600)"} href={"#3SRKbtyo_wZEc"}></use>

        <use transform={"translate(-600)"} href={"#3SRKbtyo_wZEc"}></use>

        <use transform={"translate(-300 -600)"} href={"#3SRKbtyo_wZEc"}></use>

        <use transform={"translate(0 -1200)"} href={"#3SRKbtyo_wZEc"}></use>
      </g>
    </svg>
  );
}
