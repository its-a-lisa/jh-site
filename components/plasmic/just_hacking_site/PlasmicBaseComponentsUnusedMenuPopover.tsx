...
import BaseComponentsMenuItem from "../../BaseComponentsMenuItem"; // plasmic-import: XxPlvksADibW/component
import BaseComponentsUnusedMenuSection from "../../BaseComponentsUnusedMenuSection"; // plasmic-import: JDbhW1dWGGwk/component
...
import sty from "./PlasmicBaseComponentsUnusedMenuPopover.module.css"; // plasmic-import: 9qae9ODPa9_W/css

createPlasmicElementProxy;

export type PlasmicBaseComponentsUnusedMenuPopover__VariantMembers = {};
export type PlasmicBaseComponentsUnusedMenuPopover__VariantsArgs = {};
type VariantPropType =
  keyof PlasmicBaseComponentsUnusedMenuPopover__VariantsArgs;
export const PlasmicBaseComponentsUnusedMenuPopover__VariantProps =
  new Array<VariantPropType>();

export type PlasmicBaseComponentsUnusedMenuPopover__ArgsType = {
  offset?: number;
  menuItems?: React.ReactNode;
  initialSelectedKey?: "Dynamic options";
};
type ArgPropType = keyof PlasmicBaseComponentsUnusedMenuPopover__ArgsType;
export const PlasmicBaseComponentsUnusedMenuPopover__ArgProps =
  new Array<ArgPropType>("offset", "menuItems", "initialSelectedKey");

export type PlasmicBaseComponentsUnusedMenuPopover__OverridesType = {
  root?: Flex__<typeof BasePopover>;
  ariaListBox?: Flex__<typeof BaseListBox>;
};

export interface DefaultBaseComponentsUnusedMenuPopoverProps {
  offset?: number;
  menuItems?: React.ReactNode;
  initialSelectedKey?: "Dynamic options";
  className?: string;
...
function PlasmicBaseComponentsUnusedMenuPopover__RenderFunc(props: {
  variants: PlasmicBaseComponentsUnusedMenuPopover__VariantsArgs;
  args: PlasmicBaseComponentsUnusedMenuPopover__ArgsType;
  overrides: PlasmicBaseComponentsUnusedMenuPopover__OverridesType;
  forNode?: string;
}) {
              ...
              defaultContents: (
                <React.Fragment>
                  <BaseComponentsMenuItem
                    className={classNames(
                      "__wab_instance",
                      sty.baseComponentsMenuItem__wbeMw
                    )}
                    value={"item1"}
                  />
                  ...
                  <BaseComponentsMenuItem
                    className={classNames(
                      "__wab_instance",
                      sty.baseComponentsMenuItem__ttATb
                    )}
                    label={"Item 2"}
                    value={"item2"}
                  />
                  ...
                  <BaseComponentsMenuItem
                    className={classNames(
                      "__wab_instance",
                      sty.baseComponentsMenuItem__ypk8U
                    )}
                    label={"Item 3"}
                    value={"item3"}
                  />

                  <BaseComponentsUnusedMenuSection
                    className={classNames(
                      "__wab_instance",
                      sty.baseComponentsUnusedMenuSection__vcWo6
                    )}
                    items={
                      <React.Fragment>
                        <BaseComponentsMenuItem
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicBaseComponentsUnusedMenuPopover__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    PlasmicBaseComponentsUnusedMenuPopover__VariantsArgs,
    ReservedPropsType
  > &
    /* Specify args directly as props*/ Omit<
      PlasmicBaseComponentsUnusedMenuPopover__ArgsType,
      ReservedPropsType
    > &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
      ...
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames:
            PlasmicBaseComponentsUnusedMenuPopover__ArgProps,
          internalVariantPropNames:
            PlasmicBaseComponentsUnusedMenuPopover__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicBaseComponentsUnusedMenuPopover__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicBaseComponentsUnusedMenuPopover";
  } else {
    func.displayName = `PlasmicBaseComponentsUnusedMenuPopover.${nodeName}`;
  }
  return func;
}

export const PlasmicBaseComponentsUnusedMenuPopover = Object.assign(
  // Top-level PlasmicBaseComponentsUnusedMenuPopover renders the root element
  makeNodeComponent("root"),
  {
    // Helper components rendering sub-elements
    ariaListBox: makeNodeComponent("ariaListBox"),

    // Metadata about props expected for PlasmicBaseComponentsUnusedMenuPopover
    internalVariantProps: PlasmicBaseComponentsUnusedMenuPopover__VariantProps,
    internalArgProps: PlasmicBaseComponentsUnusedMenuPopover__ArgProps
  }
);

export default PlasmicBaseComponentsUnusedMenuPopover;
/* prettier-ignore-end */
