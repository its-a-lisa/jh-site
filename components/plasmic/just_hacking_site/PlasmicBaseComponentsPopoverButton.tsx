...
import sty from "./PlasmicBaseComponentsPopoverButton.module.css"; // plasmic-import: LtbI2WZ6Twjk/css
...
function PlasmicBaseComponentsPopoverButton__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox___4Ouwa, {
            [sty.freeBoxiconStart___4OuwaSGah]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__vZjRz)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__xe618, {
            [sty.freeBoxiconEnd__xe618055Gq]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDownIcon
                className={classNames(projectcss.all, sty.svg__rAdN)}
                role={"img"}
              />
            ),
