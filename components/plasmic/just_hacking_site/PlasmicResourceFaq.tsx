...
import sty from "./PlasmicResourceFaq.module.css"; // plasmic-import: hmxYsW-AK3HY/css
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title key="title">{PlasmicResourceFaq.pageMetadata.title}</title>
        <meta
          key="og:title"
          property="og:title"
          content={PlasmicResourceFaq.pageMetadata.title}
        />
        <meta
          key="twitter:title"
          name="twitter:title"
        ...
        <meta
          key="og:image"
          property="og:image"
          content={PlasmicResourceFaq.pageMetadata.ogImageSrc}
        />
        <meta
          key="twitter:image"
          name="twitter:image"
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__co03)}
          >
            <h1
            ...
            {(_par => (!_par ? [] : Array.isArray(_par) ? _par : [_par]))(
              ...
              return (
                <Stack__
                  as={"div"}
                  hasGap={true}
                  className={classNames(projectcss.all, sty.freeBox__i3QI5)}
                  key={currentIndex}
                >
                  <h5
