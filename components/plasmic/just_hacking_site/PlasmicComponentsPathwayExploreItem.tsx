...
import sty from "./PlasmicComponentsPathwayExploreItem.module.css"; // plasmic-import: V1qlIvo8-nfi/css
...
function PlasmicComponentsPathwayExploreItem__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__skam1)}>
        {renderPlasmicSlot({
          defaultContents: (
            <h4
              className={classNames(
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__jzAuD)}
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CtfIcon
              className={classNames(projectcss.all, sty.svg__qPmMq)}
              role={"img"}
            />
          ),
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__ii6Nk)}
      >
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__unKFy)}
        >
          {renderPlasmicSlot({
            defaultContents: (
              <div
        ...
        <Stack__
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__ee3Hl)}
        >
          {renderPlasmicSlot({
            defaultContents: (
              <BaseComponentsButton
                className={classNames(
                  "__wab_instance",
                  sty.baseComponentsButton__l0Hx1
                )}
                size={undefined}
              />
            ),
